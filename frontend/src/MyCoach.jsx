		...
		<div
			...
			<div style={{ padding: "40px 60px", display: "flex", gap: "40px", flexWrap: "wrap" }}>
				...
				<div
					...
					<h2 style={{ fontSize: "20px", fontWeight: "bold", color: "#4CAF50", marginBottom: "15px" }}>Coach Information</h2>
					<p>
					...
					<p>
						<strong>Specialty:</strong> Behavioral Therapy, Smoking Cessation
					</p>
					<p>
							...
							<div
								...
								{messages.map((msg, index) => (
									<div
										...
										{index > 0 && <div style={{ fontSize: "0.7em", color: "#666", marginTop: "2px" }}>Previous: {new Date(messages[index - 1].chat_date).toLocaleTimeString()}</div>}
										<div style={{ fontSize: "0.7em", color: "#666" }}>{msg.status === "Replied" && " (Replied)"}</div>
									</div>
								))}
							</div>
